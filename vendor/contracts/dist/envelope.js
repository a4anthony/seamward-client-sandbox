...
const shapeSchema = z.lazy(() => z.union([
    ...
    z.object({ kind: z.literal("array"), items: z.array(shapeSchema) }).strict(),
    z.object({ kind: z.literal("object"), fields: z.record(shapeSchema) }).strict(),
]));
/**
 ...
 */
export const ENVELOPE_VERSION = "0.1";
